        ...
        <div className="bg-slate-50">
            <div className="fixed z-50 flex h-24 w-full items-center justify-between border-b-4 border-slate-300 bg-slate-50 p-3 text-slate-900 md:justify-center md:px-12 md:py-6 lg:justify-center lg:px-12 lg:py-6">
                <div className="hidden md:flex lg:flex">
                    ...
                    <Link href="/profile" className="mx-5 text-sky-600">
                    ...
                    <Link href="/history" className="mx-5 duration-300 ease-in-out hover:text-sky-600">
            ...
            <div className={`fixed left-0 top-0 size-full ${isMenuOpen ? "bg-white/30 backdrop-blur-xl transition-all duration-300" : "hidden transition-all duration-300"}`}></div>
            <div className={`mobile-menu fixed right-0 top-0 h-full w-56 translate-x-full overflow-hidden border-l-4 border-slate-300 bg-slate-50 text-slate-900 md:hidden lg:hidden`}>
