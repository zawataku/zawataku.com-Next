...
import Header_Skill from "../common/header_skill";
    ...
    return (
        <div className="bg-slate-50">
            ...
            <div className="mx-auto max-w-5xl px-6 pb-24 pt-32">
                <h1 className="pb-3 text-center text-5xl font-semibold text-slate-900">Skill</h1>
                <p className="mb-24 text-center text-lg text-slate-900">こんな技術が使えます</p>

                <div className="mx-auto grid gap-6 sm:grid-cols-2 lg:grid-cols-3 ">

                    {/* HTML/CSSここから */}
                    <div className="group relative z-10 m-2  rounded-md bg-white p-4 shadow-xl transition-all duration-500 hover:bg-slate-500 hover:shadow-xl">
                        ...
                        <div className="relative px-9 py-2  ">
                            ...
                            <p className="mt-4 text-base text-slate-600 group-hover:text-white">旧ホームページで使っていた言語たち．</p>
                        </div>
                    </div>
                    {/* HTML/CSSここまで */}
                    ...
                    <div className="group relative z-10 m-2  rounded-md bg-white p-4 shadow-xl transition-all duration-500 hover:bg-slate-500 hover:shadow-xl">
                        ...
                        <div className="relative px-9 py-2  ">
                            ...
                            <p className="mt-4 text-base text-slate-600 group-hover:text-white">主にReactとNext.jsで使用している言語．</p>
                        </div>
                    </div>
                    {/* TSここまで */}
                    ...
                    <div className="group relative z-10 m-2  rounded-md bg-white p-4 shadow-xl transition-all duration-500 hover:bg-slate-500 hover:shadow-xl">
                        ...
                        <div className="relative px-9 py-2  ">
                            ...
                            <p className="mt-4 text-base text-slate-600 group-hover:text-white">最近使い始めたとっても優秀なフロントエンドライブラリ．</p>
                        </div>
                    </div>
                    {/* Reactここまで */}
                    ...
                    <div className="group relative z-10 m-2  rounded-md bg-white p-4 shadow-xl transition-all duration-500 hover:bg-slate-500 hover:shadow-xl">
                        ...
                        <div className="relative px-9 py-2  ">
                            ...
                            <p className="mt-4 text-base text-slate-600 group-hover:text-white">Reactとセットで使ってるJSライブラリ．</p>
                        </div>
                    </div>
                    {/* Nextここまで */}
                    ...
                    <div className="group relative z-10 m-2  rounded-md bg-white p-4 shadow-xl transition-all duration-500 hover:bg-slate-500 hover:shadow-xl">
                        ...
                        <div className="relative px-9 py-2  ">
                            ...
                            <p className="mt-4 text-base text-slate-600 group-hover:text-white">愛してやまないCSSフレームワーク．</p>
                        </div>
                    </div>
                    {/* Tailwindここまで */}
                </div>
